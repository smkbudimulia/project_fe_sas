...
const Schedule = () => {
  ...
  //     jam_pulang: [
  //       formatTime(departureTimes.from),
  //       formatTime(departureTimes.to),
  //     ],
  //     jam_terlambat: [
  //       formatTime(latenessTimes.from),
  //       formatTime(latenessTimes.to),
  //     ],
  ...
  //     const responseExistingData = await axios.get(
  //       `${baseUrl}/setting/all-setting`
  //     );
  ...
  //     const daysToInsert = selectedDays.filter(
  //       (day) => !existingData.some((item: any) => item.hari === day)
  //     );
  ...
  //         `${baseUrl}/setting/setting-sistem`,
  //         updateData
  //       );
  ...
  //     setHolidayDate(""); // Reset tanggal libur setelah simpan atau update
  //   } catch (error) {
